...
-- Seed Mock Jobs and Suppliers for testing
INSERT INTO jobs (job_number, job_name, location) VALUES
('JOB-001', 'Downtown Skyscraper', 'Downtown Area'),
('JOB-002', 'Airport Terminal B Expansion', 'International Airport');

INSERT INTO suppliers (supplier_name, contact_person, phone_number) VALUES
('Heavy Lift Equipments LLC', 'Ahmed', '555-0101'),
('Labour Solutions Co', 'Sarah', '555-0202');
