      ...
      <View className={`flex-row justify-between items-center mb-8 ${isMobile ? 'flex-wrap gap-y-4' : ''}`}>
        <View>
          <View className="flex-row items-center">
            <Text className="text-slate-900 text-3xl font-black tracking-tight mr-3">Admins</Text>
          ...
          <Text className="text-slate-500 mt-1">Manage Administrators and system access.</Text>
        </View>
        <TouchableOpacity 
        ...
        >
          ...
          <Text className="text-white font-bold ml-2">New Admin</Text>
        </TouchableOpacity>
      </View>
          ...
          <View className="bg-white w-full max-w-md rounded-2xl p-6 shadow-xl">
            <View className="flex-row justify-between items-center mb-6">
              <View className="flex-row items-center">
                ...
                <Text className="text-xl font-black text-slate-900">Add Admin</Text>
              </View>
